...
import { ArrowLeft, Home, QrCode as QrIcon, History as HistoryIcon, User as UserIcon, LogOut, Edit2, Check, X } from 'lucide-react-native';
      ...
      <View style={styles.content}>
        ...
        {isEditing ? (
          ...
          <View style={styles.nameRow}>
            <Text style={styles.title}>{user?.name || 'Security Officer'}</Text>
        ...
        <Text style={styles.subtitle}>{user?.email || 'guard@example.com'}</Text>
