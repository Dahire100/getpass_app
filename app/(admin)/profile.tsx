...
import { ArrowLeft, Home, LayoutList, UserCircle, LogOut, QrCode as QrIcon, Edit2, Check, X } from 'lucide-react-native';
      ...
      <View style={styles.content}>
        ...
        {isEditing ? (
          ...
          <View style={styles.nameRow}>
            <Text style={styles.title}>{user?.name || 'Administrator'}</Text>
